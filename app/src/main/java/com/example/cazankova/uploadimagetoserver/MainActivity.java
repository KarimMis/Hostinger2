...
//Now we need to create one more method that will upload the image to our server.
  //  Now for uploading the selected image we need to convert the Bitmap to String.
    ...
    //NNow create one more method to upload the image to server. Create the following method in MainActivity class.
